...
export function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      className={cn(
        "relative flex cursor-pointer items-center justify-between gap-3 rounded-2xl px-3 py-3 text-sm outline-none transition data-[selected=true]:bg-white/8 data-[selected=true]:text-white",
        className,
      )}
      {...props}
    />
