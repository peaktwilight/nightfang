...
export function EntityListItem({
  ...
  return (
    <div
      className={cn(
        "rounded-[1.2rem] border border-white/8 bg-white/[0.03] p-4 transition duration-150 hover:-translate-y-0.5 hover:border-white/14 hover:bg-white/[0.05]",
        selected && "border-[var(--accent)]/30 bg-[var(--accent)]/10 shadow-[0_0_0_1px_rgba(102,217,255,0.12)]",
      )}
    >
