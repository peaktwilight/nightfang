import type { TargetInfo, Finding } from "@nightfang/shared";

export function discoveryPrompt(target: string): string {
  return `You are the Discovery Agent for Nightfang AI red-teaming toolkit.
...
export function attackPrompt(
  ...
  return `You are the Attack Agent for Nightfang AI red-teaming toolkit.
...
export function verifyPrompt(target: string, findings: Finding[]): string {
  ...
  return `You are the Verification Agent for Nightfang AI red-teaming toolkit.
...
export function reportPrompt(findings: Finding[]): string {
  ...
  return `You are the Report Agent for Nightfang AI red-teaming toolkit.
